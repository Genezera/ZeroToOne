...
- Confiança da evidência de deploy: **high** — `configs/kubernetes-configmap.yaml` (o manifesto real do repositório, distinto de `configs/example-configmap.yaml`) declara `rules-file: https://raw.githubusercontent.com/kubernetes/kubernetes/master/staging/publishing/rules.yaml`, confirmando que o deployment real usa exatamente o caminho `readFromURL()` investigado.
